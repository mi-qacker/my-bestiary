            ...
            <div className={styles.info}>
                ...
                <div className={styles.describe}>
                    <p>
                        ...
                        оттенков. Черт меньше беса по размерам, а также отличается формой рогов — они у него не
                        ветвистые, оленьи, а завитые, бараньи. Эти существа предпочитают обитать в лесных чащобах или
                        неглубоких пещерах, яростно охраняют свою территорию и свирепо расправляются с любым
                        конкурентом. Черты всеядны и не брезгуют ни мясом, ни растительной пищей.
                    </p>
                </div>
            </div>
        </div>
